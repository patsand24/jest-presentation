...
var _stateFunctions = __webpack_require__(31);
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.addTodo = function (item) {
      _this.setState((0, _stateFunctions.addTodo)(_this.state, item));
    };

    _this.toggle = function (index) {
      return function () {
        _this.setState((0, _stateFunctions.toggleTodo)(_this.state, index));
      };
    };

    _this.remove = function (index) {
      return function () {
        _this.setState((0, _stateFunctions.removeTodo)(_this.state, index));
      };
    };
    ...
    value: function render() {
      ...
      var newTodos = todos.map(function (todo, index) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'span',
            { style: style, onClick: _this2.toggle(index), className: "clickable" },
            todo.text
          ),
          todo.complete ? _react2.default.createElement(
            'span',
            { style: { color: 'red' }, className: "clickable", onClick: _this2.remove(index) },
            'COMPLETE'
          ) : null
        );
      });
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { id: 'content' },
          _react2.default.createElement(_input2.default, { enterClick: this.addTodo }),
          newTodos
        )
      );
    }
...
var Input = function (_Component) {
  ...
  function Input(props) {
    ...
    _this.enterText = function (e) {
      _this.setState({ inputText: e.target.value });
    };

    _this.clickEnter = function () {
      var enterClick = _this.props.enterClick;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { className: 'inputBox', type: 'text', onChange: this.enterText, value: inputText }),
          _react2.default.createElement(
            'span',
            { className: 'clickable', onClick: this.clickEnter },
            'Enter'
          )
        )
      );
...
var toggleTodo = exports.toggleTodo = function toggleTodo(state, index) {
  if (index === undefined || index < 0 || index >= state.todos.length) {
    return state;
  }
  var todo = state.todos[index];
  todo.complete = !todo.complete;
  return Object.assign(state, { todos: [].concat(_toConsumableArray(state.todos.slice(0, index)), [todo], _toConsumableArray(state.todos.slice(index + 1))) });
};

var addTodo = exports.addTodo = function addTodo(state, todo) {
  if (todo === undefined || todo === '') {
    return state;
  }
  var newTodo = { text: todo, complete: false };
  var newState = state.todos.concat([newTodo]);
  return Object.assign(state, { todos: newState });
};

var removeTodo = exports.removeTodo = function removeTodo(state, index) {
  if (index === undefined || index < 0 || index >= state.todos.length) {
    return state;
  }
  var newTodos = [].concat(_toConsumableArray(state.todos.slice(0, index)), _toConsumableArray(state.todos.slice(index + 1)));
...
var headerTitle = exports.headerTitle = "Generic To Do App";
